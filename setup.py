...
setup(
    ...
    package_dir={
        'selenium_old': 'py/selenium',
        'selenium_old.webdriver': 'py/selenium/webdriver',
        'selenium_old.webdriver.chrome': 'py/selenium/webdriver/chrome',
        'selenium_old.webdriver.common': 'py/selenium/webdriver/common',
        'selenium_old.webdriver.firefox': 'py/selenium/webdriver/firefox',
        'selenium_old.webdriver.ie': 'py/selenium/webdriver/ie',
        'selenium_old.webdriver.remote': 'py/selenium/webdriver/remote'
    },
    packages=['selenium_old',
              'selenium_old.webdriver',
              'selenium_old.webdriver.chrome',
              'selenium_old.webdriver.common',
              'selenium_old.webdriver.firefox',
              'selenium_old.webdriver.ie',
              'selenium_old.webdriver.remote'],
    package_data={
        'selenium_old.webdriver.firefox': ['*.xpi'],
        'selenium_old.webdriver.ie': ['*.dll'],
